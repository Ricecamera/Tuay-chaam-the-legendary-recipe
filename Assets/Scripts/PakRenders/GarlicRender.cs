...
public class GarlicRender : PakRender
{
    ...
    protected override void Start()
    {
        ...
        skill.Add(new Buum("B:)", "AttackWholeField", "Dealt a great amount of damages to the whole field at a cost of sacrifices the Pak who use this action.", 3, skillIconUnti));
