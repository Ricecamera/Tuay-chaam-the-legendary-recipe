...
public class GarlicRender : PakRender
{
    ...
    protected override void Start()
    {
        ...
        skill.Add(new VanillaBuffDefAll("VBDA", "BuffDefAllAlliance", "Buff all alliance to increase their defense for the duration of this battle.", 3, skillIcon3));
        skill.Add(new Buum("B:)", "AttackWholeField", "Dealt a great amount of damages to the whole field at a cost of sacrifices the Pak who use this action.", 4, skillIconUnti));
    }
