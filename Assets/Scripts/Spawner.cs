    ...
    public class Spawner : MonoBehaviour {
        ...
        void Start() {
            ...
            for (int i = 0; i < plants.Count; i++) {
                ...
                p.GetComponent<PakRender>().plantpos = allySpawnPos[i].gameObject ;
                allySpawnPos[i].GetComponent<PakRender>().plantpos = allySpawnPos[i].gameObject ;
            ...
            chaamObject.GetComponent<PakRender>().plantpos = chaamSpawnPos.gameObject ; //--------------------
            chaamSpawnPos.GetComponent<PakRender>().plantpos = chaamSpawnPos.gameObject;
            ...
            bossObject.GetComponent<PakRender>().plantpos = bossSpawnPos.gameObject ; //--------------------
            bossSpawnPos.GetComponent<PakRender>().plantpos = bossSpawnPos.gameObject;
